                                    ...
                                    <div class="collapse" id="atr_umur">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Mean_layak_Umur" name="Mean_layak_Umur" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Layak']['Age'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Mean_tidak_layak_Umur"><strong><i>Mean (Class Tidak Layak)</i></strong></label>
                                                <input type="text" class="form-control" id="Mean_tidak_layak_Umur" name="Mean_tidak_layak_Umur" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Tidak_Layak']['Age'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Layak_Umur"><strong><i>Standar Deviasi (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Layak_Umur" id="Standar_Deviasi_Layak_Umur" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Layak']['Age'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Tidak_Layak_Umur"><strong><i>Standar Deviasi (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Tidak_Layak_Umur" id="Standar_Deviasi_Tidak_Layak_Umur" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Tidak_Layak']['Age'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Umur_Layak"><strong><i>Distribusi Gaussian (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Umur_Layak" id="Gaussian_Umur_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Layak']['Age'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Umur_Tidak_Layak"><strong><i>Distribusi Gaussian (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Umur_Tidak_Layak" id="Gaussian_Umur_Tidak_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Tidak_Layak']['Age'] }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="collapse" id="atr_bb">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Mean_layak_Berat_Badan" name="Mean_layak_Berat_Badan" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Layak']['Weight'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Mean_tidak_layak_Berat_Badan"><strong><i>Mean (Class Tidak Layak)</i></strong></label>
                                                <input type="text" class="form-control" id="Mean_tidak_layak_Berat_Badan" name="Mean_tidak_layak_Berat_Badan" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Tidak_Layak']['Weight'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Layak_Berat_Badan"><strong><i>Standar Deviasi (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Layak_Berat_Badan" id="Standar_Deviasi_Layak_Berat_Badan" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Layak']['Weight'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Tidak_Layak_Berat_Badan"><strong><i>Standar Deviasi (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Tidak_Layak_Berat_Badan" id="Standar_Deviasi_Tidak_Layak_Berat_Badan" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Tidak_Layak']['Weight'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Berat_Badan_Layak"><strong><i>Distribusi Gaussian (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Berat_Badan_Layak" id="Gaussian_Berat_Badan_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Layak']['Weight'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Berat_Badan_Tidak_Layak"><strong><i>Distribusi Gaussian (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Berat_Badan_Tidak_Layak" id="Gaussian_Berat_Badan_Tidak_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Tidak_Layak']['Weight'] }}" readonly>
                                            </div>      
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="collapse" id="atr_hemoglobin">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Mean_layak_Hemoglobin" name="Mean_layak_Hemoglobin" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Layak']['Hemoglobin'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Mean_tidak_layak_Hemoglobin"><strong><i>Mean (Class Tidak Layak)</i></strong></label>
                                                <input type="text" class="form-control" id="Mean_tidak_layak_Hemoglobin" name="Mean_tidak_layak_Hemoglobin" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Tidak_Layak']['Hemoglobin'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Layak_Hemoglobin"><strong><i>Standar Deviasi (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Layak_Hemoglobin" id="Standar_Deviasi_Layak_Hemoglobin" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Layak']['Hemoglobin'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Tidak_Layak_Hemoglobin"><strong><i>Standar Deviasi (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Tidak_Layak_Hemoglobin" id="Standar_Deviasi_Tidak_Layak_Hemoglobin" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Tidak_Layak']['Hemoglobin'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Hemoglobin_Layak"><strong><i>Distribusi Gaussian (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Hemoglobin_Layak" id="Gaussian_Hemoglobin_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Layak']['Hemoglobin'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Hemoglobin_Tidak_Layak"><strong><i>Distribusi Gaussian (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Hemoglobin_Tidak_Layak" id="Gaussian_Hemoglobin_Tidak_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Tidak_Layak']['Hemoglobin'] }}" readonly>
                                            </div>   
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="collapse" id="atr_pressure_sistole">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Mean_layak_Pressure_Sistole" name="Mean_layak_Pressure_Sistole" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Mean_tidak_layak_Pressure_Sistole"><strong><i>Mean (Class Tidak Layak)</i></strong></label>
                                                <input type="text" class="form-control" id="Mean_tidak_layak_Pressure_Sistole" name="Mean_tidak_layak_Pressure_Sistole" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Tidak_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Layak_Pressure_Sistole"><strong><i>Standar Deviasi (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Layak_Pressure_Sistole" id="Standar_Deviasi_Layak_Pressure_Sistole" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Tidak_Layak_Pressure_Sistole"><strong><i>Standar Deviasi (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Tidak_Layak_Pressure_Sistole" id="Standar_Deviasi_Tidak_Layak_Pressure_Sistole" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Tidak_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Pressure_Sistole_Layak"><strong><i>Distribusi Gaussian (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Pressure_Sistole_Layak" id="Gaussian_Pressure_Sistole_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Pressure_Sistole_Tidak_Layak"><strong><i>Distribusi Gaussian (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Pressure_Sistole_Tidak_Layak" id="Gaussian_Pressure_Sistole_Tidak_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Tidak_Layak']['Pressure_Sistole'] }}" readonly>
                                            </div>   
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="collapse" id="atr_pressure_diastole">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="Mean_layak_Pressure_Diastole" name="Mean_layak_Pressure_Diastole" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Mean_tidak_layak_Pressure_Diastole"><strong><i>Mean (Class Tidak Layak)</i></strong></label>
                                                <input type="text" class="form-control" id="Mean_tidak_layak_Pressure_Diastole" name="Mean_tidak_layak_Pressure_Diastole" value="{{ $Result_Classifier[0]->Mean_Each_Class['Class_Tidak_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Layak_Pressure_Diastole"><strong><i>Standar Deviasi (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Layak_Pressure_Diastole" id="Standar_Deviasi_Layak_Pressure_Diastole" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Standar_Deviasi_Tidak_Layak_Pressure_Diastole"><strong><i>Standar Deviasi (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Standar_Deviasi_Tidak_Layak_Pressure_Diastole" id="Standar_Deviasi_Tidak_Layak_Pressure_Diastole" value="{{ $Result_Classifier[0]->Standar_Deviasi_Each_Class['Class_Tidak_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Pressure_Diastole_Layak"><strong><i>Distribusi Gaussian (Class Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Pressure_Diastole_Layak" id="Gaussian_Pressure_Diastole_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="Gaussian_Pressure_Diastole_Tidak_Layak"><strong><i>Distribusi Gaussian (Class Tidak Layak)</i></strong></label>
                                                <input class="form-control" type="text" name="Gaussian_Pressure_Diastole_Tidak_Layak" id="Gaussian_Pressure_Diastole_Tidak_Layak" value="{{ $Result_Classifier[0]->Gaussian_Each_Class['Class_Tidak_Layak']['Pressure_Diastole'] }}" readonly>
                                            </div>   
                                        </div>
                                    </div>
                                </div>

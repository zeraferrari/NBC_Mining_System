        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('Manajement.Rhesus.update', $data->id) }}" method="POST">
                        {{ csrf_field() }}
                        @method('PATCH')
                            ...
                            <div class="col text-center">
                                <button type="submit" class="btn btn-primary btn-md col-sm-12 col-md-6 col-lg-6">Update</button>
                            </div>
                        </form>
                    </div>
                </div>

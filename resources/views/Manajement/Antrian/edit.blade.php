...
@section('Main_Content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Kode Transaksi : {{ $transaction_data->Code_Transaction }}</h2>
            <div class="card">
            ...
            <div class="row mt-sm-5">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="card profile-widget">
                        <div class="profile-widget-header">
                            @if($transaction_data->User_Connection->profile_picture)
                                <img src="{{ asset('storage/'.$transaction_data->User_Connection->profile_picture) }}" alt="Gambar Profile" class="rounded-circle profile-widget-picture" style="height: 100px;">
                            @else
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                <td>Nama</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->name }}</td>
                                            </tr>
                                            <tr>
                                                <td>NIK</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->NIK }}</td>
                                            </tr>
                                            <tr>
                                                <td>Golongan Darah</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->Rhesus_Connection->Name ?? 'Belum Diketahui' }}</td>
                                            </tr>
                                            <tr>
                                                <td>Gender</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->Gender }}</td>
                                            </tr>
                                            <tr>
                                                <td>Nomor Whatsapp/Handphone</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->phone_number }}</td>
                                            </tr>
                                            <tr>
                                                <td>Alamat</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->alamat }}</td>
                                            </tr>
                                            <tr>
                                                <td>Status Donor</td>
                                                <td>:</td>
                                                <td>{{ $transaction_data->User_Connection->Status_Donor }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('Manajement.Transaction.update',$transaction_data->id) }}" method="POST">
                                {{ csrf_field() }}
                                @method('PATCH')
                                <div class="form-group">
                                    ...
                                    <select name="Rhesus_Categories" id="Rhesus_Categories" class="form-control @error('Rhesus_Categories') is-invalid @enderror">
                                        ...
                                        @foreach ($rhesus_data as $data_rhesus)
                                            <option value="{{ $data_rhesus->id }}" @if(($transaction_data->User_Connection->Rhesus_Connection->Name ?? '') === $data_rhesus->Name) selected @endif>{{ $data_rhesus->Name }}</option>
                                        @endforeach
                                    </select>
